...
document.getElementById('exportBtn').onclick=()=>{const blob=new Blob([JSON.stringify({version:1.4,exportedAt:new Date().toISOString(),properties},null,2)],{type:'application/json'}),a=document.createElement('a');a.href=URL.createObjectURL(blob);a.download='property-deal-analyser.json';a.click();URL.revokeObjectURL(a.href)};
